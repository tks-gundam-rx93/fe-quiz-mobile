(() => {
  ...
  function prepareTerm(t){ const order=shuffledIndexes(t.options.length); return {...t,displayOptions:order.map(i=>t.options[i]),displayAnswer:order.indexOf(t.answer)}; }
